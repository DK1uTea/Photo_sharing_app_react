...
// Lưu ý: Khai báo thông tin người dùng khác ở đây

const users = [im, er, pt, rk, al, jo]; // Thêm các đối tượng người dùng khác vào mảng users

// Create initial photos.
// Lưu ý: Khai báo các đối tượng photo khác ở đây
const photo1 = {
...
const photos = [photo1, photo2, photo3, photo4, photo5, photo6, photo7, photo8, photo9, photo10, photo11, photo12]; // Thêm các đối tượng photo khác vào mảng photos

// Create initial comments.
// Lưu ý: Khai báo các đối tượng comment khác ở đây
const comment1 = {
...
const comments = [comment1, comment2, comment3, comment4, comment5, comment6, comment7, comment8, comment9, comment10, comment11, comment12, comment13]; // Thêm các đối tượng comment khác vào mảng comments

comments.forEach(function (comment) {
  const photo = photos.find((photo) => photo._id === comment.photo_id);
  if (!photo.comments) {
    photo.comments = [];
  }
...
const commentsOfPhotoModel = function (photoId) {
...
export { userListModel, userModel, photoOfUserModel, schemaModel, commentsOfPhotoModel };
